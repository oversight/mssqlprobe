...
SELECT
    ...
    MAX (W1.wait_type) AS [name],
    CAST (MAX (W1.WaitS) AS DECIMAL (16,2)) AS [wait_time_sec],
    CAST (MAX (W1.ResourceS) AS DECIMAL (16,2)) AS [resource_sec],
    CAST (MAX (W1.SignalS) AS DECIMAL (16,2)) AS [signal_sec],
    MAX (W1.WaitCount) AS [wait_count],
    CAST (MAX (W1.Percentage) AS DECIMAL (5,2)) AS [wait_percentage],
    CAST ((MAX (W1.WaitS) / MAX (W1.WaitCount)) AS DECIMAL (16,4)) AS [avg_wait_sec],
    CAST ((MAX (W1.ResourceS) / MAX (W1.WaitCount)) AS DECIMAL (16,4)) AS [avg_res_sec],
    CAST ((MAX (W1.SignalS) / MAX (W1.WaitCount)) AS DECIMAL (16,4)) AS [avg_sig_sec]
FROM Waits AS W1
